...
(* OASIS_START *)
(* DO NOT EDIT (digest: 820c8833554cf093a602400fd13c6faa) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "OCaml Bindings to brotli, Google's new compression algorithm Uses Bigarrays for memory efficiency and ready for Lwt concurrency Source: https://github.com/google/brotli/ RFC: http://www.ietf.org/id/draft-alakuijala-brotli"
              ];
          categories = [];
          ...
          build_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("sh", ["prepare.sh"])))];
               post_command = [(OASISExpr.EBool true, None)]
            };
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_byteopt = [(OASISExpr.EBool true, ["-cc"; "g++"])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "@\163|\rA\255\b\231\135\151?5s\2261\231";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
