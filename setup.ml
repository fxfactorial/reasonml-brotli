...
(* OASIS_START *)
(* DO NOT EDIT (digest: bd547dca48975bedd0594eaf727e3d8a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "OCaml Bindings to brotli, Google's new compression algorithm Source: https://github.com/google/brotli/ RFC: http://www.ietf.org/id/draft-alakuijala-brotli Comes with command line tool called brozip"
              ];
          categories = [];
               ...
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("python", ["build.py"; "--prepare"])))
                 ];
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("python", ["build.py"; "--cleanup"])))
                 ]
            };
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_cclib =
                        [(OASISExpr.EBool true, ["-lbrotli"; "-lstdc++"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, ["-cc"; "clang"])];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-cc"; "clang"])]
                   },
                   {
                      lib_modules = ["Brotli"];
                      lib_pack = false;
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for brotli";
                      doc_authors = ["Edgar Aroutiounian"];
                      doc_abstract = None;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ÇÃ\129$\028\136\158\014Ê'2ß\031\142XÐ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
