...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8de83512bb595dd61929b1eecacc270c) *)
(*
...
let setup_t =
  {
               ...
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("python3", ["build.py"; "--prepare"])))
                 ];
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("python3", ["build.py"; "--cleanup"])))
                 ]
            };
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\140\152qÄ¥«Ôc7ô{\014eÀ\003¸";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
