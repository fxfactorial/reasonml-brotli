...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8d416cae486039e50efc53b17bef5fe1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "OCaml Bindings to brotli, Google's new compression algorithm Source: https://github.com/google/brotli/ RFC: http://www.ietf.org/id/draft-alakuijala-brotli"
              ];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "l×\133\153¦ÞVCs·è6\1489Ö\151";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
